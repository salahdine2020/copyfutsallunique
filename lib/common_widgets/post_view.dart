...
import 'package:futsal_unique/common_widgets/heart_anime.dart';
...
import 'package:futsal_unique/utilities/zoomOverlay.dart';
...
//    }
  ...
  _likePost() {
    if (_isLiked) {
      // Unlike Post
//      DatabaseService.unlikePost(currentUserId: widget.currentUserId, post: _post);
      setState(() {
        _isLiked = false;
        //_likeCount--;
      });
...
//                        );
              ...
              _post!.authorId == widget.currentUserId &&
                  ...
                  ? SimpleDialogOption(
                      child: Text(
                        'Allow comments',
//                        _post.commentsAllowed
//                          ? 'Turn off commenting'
//                          : 'Allow comments',
                      ),
                      onPressed: () {
                        //todo: DatabaseService.allowDisAllowPostComments(_post, !_post.commentsAllowed);
                        Navigator.pop(context);
                        setState(() {
//                          _post = new Post(
                  ...
                  child: ListTile(
                    leading: GestureDetector(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: AssetImage(placeHolderImageRef),
...
//                      ),
                    ...
                    subtitle: _post.location!.isNotEmpty
                        ? Text(_post.location.toString())
                        : null,
                    //todo: trailing: IconButton(icon: Icon(Icons.more_vert), onPressed: _showMenuDialog),
                  ),
                ),
                //Spacer(),
                IconButton(
...
//                      ),
                ...
                _heartAnim ?
                Positioned(top: 100,left: 120, child: HeartAnime(200),) : SizedBox.shrink(),
              ],
            ),
          ),
          Padding(
