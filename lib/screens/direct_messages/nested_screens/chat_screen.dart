...
import 'package:futsal_unique/screens/direct_messages/widgets/message_bubble.dart';
...
class ChatScreen extends StatefulWidget {
  final UserModelClass receiverUser;
  final File? imageFile;

  const ChatScreen({required this.receiverUser, this.imageFile});
  @override
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  List<UserModelClass>? _memberInfo;
  ...
  _setup() async {
    ...
    ChatUsers? chat = await ChatService.getChatByUsers(userIds);
    ...
    if (isChatExist) {
      ...
      ChatUsers chatWithMemberInfo = ChatUsers(
        id: chat.id,
                ...
                children: [
                  ...
                  SimpleDialogOption(
                    ...
                    onPressed: () async {
                      ...
                      String imageUrl = await StroageService.uploadMessageImage(widget!.imageFile!);
  ...
  Future<void> _createChat(userIds) async {
    ChatUsers chat = await ChatService.createChat(_memberInfo!, userIds);
  ...
  List<MessageBubble> _buildMessageBubbles(messages) { //todo: AsyncSnapshot<QuerySnapshot?>?
            ...
            children: [
              GestureDetector(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: CachedNetworkImageProvider(widget!.receiverUser!.profileImageUrl!),
                  // widget.receiverUser.profileImageUrl.isEmpty
                  //     ? AssetImage(placeHolderImageRef)
                  //     : CachedNetworkImageProvider(widget.receiverUser.profileImageUrl),
                ),
              ),
              SizedBox(width: 15.0),
              GestureDetector(
