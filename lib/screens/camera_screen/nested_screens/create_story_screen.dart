...
import 'package:futsal_unique/screens/camera_screen/widgets/custom_text_form.dart';
import 'package:futsal_unique/screens/camera_screen/widgets/duration_form.dart';
import 'package:futsal_unique/screens/camera_screen/widgets/location_form.dart';
...
import 'package:futsal_unique/services/core/liquid_swipe_pages.dart';
import 'package:futsal_unique/services/services.dart';
import 'package:futsal_unique/services/core/url_validator_service.dart';
import 'package:futsal_unique/utilities/constants.dart';
import 'package:futsal_unique/utilities/custom_navigation.dart';
import 'package:futsal_unique/utilities/filters.dart';
...
class _CreateStoryScreenState extends State<CreateStoryScreen> {
  ...
  Widget build(BuildContext context) {
    final UserModelClass? _currentUser = Provider.of<UserData>(context).currentUser;
  ...
  Align _displayLocationText() {
    return Align(
      //todo: alignment: Alignment.lerp(Alignment.center, Alignment.bottomCenter, 0.6),
      child: Row(
  ...
  Align _displayBottomButtons(UserModelClass _currentUser) {
    return Align(
  ...
  Align _displayStoryCaption() {
    return Align(
      //todo: alignment: Alignment.lerp(Alignment.center, Alignment.bottomCenter, 0.4),
      child: Text(
        _storyCaption,
  ...
  Align _displayEditStoryButtons(UserModelClass currentuser) {
    int? _duration;
    return Align(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  CircularIconButton(
                    ...
                    onTap: () => _showEditStory(
                      onSave: () async {
                        String? url = await UrlValidatorService.isUrlValid(context, _linkController.text.trim());
                        if (url != null) {
  ...
  void _createStory(String currentUserId) async {
    if (!_isLoading && widget.imageFile != null) {
      ...
      File imageFile = await FilteredImageConverter.convert(globalKey: _globalKey);
      if (imageFile == null) {
