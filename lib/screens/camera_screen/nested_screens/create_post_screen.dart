...
import 'package:futsal_unique/screens/camera_screen/widgets/post_caption_form.dart';
...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  initState() {
    ...
    if (widget.post != null) {
      setState(() {
        ...
        _locationController.value = TextEditingValue(text: widget.post!.location!);
  ...
  void _submit() async {
    ...
    if (!_isLoading && _formKey.currentState!.validate() && (widget.imageFile != null || _post!.imageUrl != null)) {
      ...
      if (_post != null) {
        ...
        //Create new Post
        print('you are here to creat post');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text(widget.imageFile == null ? 'Edit Post' : 'New Post', style: TextStyle(color: Colors.white),),
          actions: <Widget>[
            !_isLoading ? FlatButton(
              ...
              padding: const EdgeInsets.only(right: 10.0), child: Center(
                      child: SizedBox(
