...
class _StoriesWidgetState extends State<StoriesWidget> {
  ...
  List<UserModelClass> _followingUsers = [];
  List<Story> _stories = [];
  ...
  Future<void> _getStories() async {
    ...
    List<UserModelClass> followingUsersWithStories = [];
    ...
    for (UserModelClass user in widget.users) {
  ...
  StoryCircle _buildStoryCircle(int index) {
    UserModelClass user = _followingUsers[index];
