...
class CommentsScreen extends StatefulWidget {
  ...
  CommentsScreen({this.post, this.likeCount, this.author, required this.postStatus});
...
class _CommentsScreenState extends State<CommentsScreen> {
  ...
  _buildListTile(BuildContext context, UserModelClass author, Comment comment,
    ...
    return ListTile(
      leading: GestureDetector(
        ...
        child: CircleAvatar(
          ...
          backgroundImage: CachedNetworkImageProvider(author.profileImageUrl!),
          ...
          children: <Widget>[
            ...
            Expanded(
              child: AutoDirection(
                ...
                child: TextField(
                  enabled: widget!.post!.commentsAllowed! && widget.postStatus == PostStatus.feedPost,
            ...
            Container(
              ...
              child: IconButton(
                ...
                onPressed: widget.postStatus != PostStatus.feedPost || !widget!.post!.commentsAllowed!
                    ? null
                    : () {
                        if (_isCommenting) {
