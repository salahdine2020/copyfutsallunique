...
class _AboutAppDialogState extends State<AboutAppDialog> {
  ...
  _reportABug() async {
    UserModelClass user = await DatabaseService.getUserWithId('kAdminUId'); /// kAdminUId
  ...
  Widget build(BuildContext context) {
    return SimpleDialog(
          ...
          Container(
            ...
            child: GestureDetector(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: CachedNetworkImageProvider('https://edenik.com/assets/images/profile.png'),
              ),
            ),
          ),
          SizedBox(height: 5),
      ...
      children: <Widget>[
        ...
        if (!_isLoading && !_isFollowing && widget.currentUserId != 'kAdminUId') ///kAdminUId
          Divider(),
        !_isFollowing && !_isLoading && widget.currentUserId != 'kAdminUId' /// kAdminUId
            ? SimpleDialogOption(
                child: Center(
                  child: Text(
                    _followText,
